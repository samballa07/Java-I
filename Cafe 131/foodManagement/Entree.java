...
public class Entree implements Listable {
	...
	public String getName() {
		return name; //returns String for name
	}
	...
	public SortedListOfImmutables getFoodList() {
		//calls copy constructor and returns a reference copy of foodList
	...
	public boolean equals(Object other) {
		//checks if the other object is of type Entree and returns false if not
		if(!(other instanceof Entree)) {
			return false;
		}
		
		Entree entree = (Entree)other; //type casts other to entree type
		return entree.name.equals(name); //returns true if names are equals
	}
